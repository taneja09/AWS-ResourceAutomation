...
aws cloudformation create-stack --stack-name "$stackname" --region "$region" --template-body file://application.json --parameters file://variables.json 2>/dev/null || { echo "A stack with this name already exist in the provided region. "; exit 1;}
